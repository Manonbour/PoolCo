...
if(isset($_POST["AjPho"]))
{
  ...
  echo $ch = "images/".$filename.".".$type;
  $id = $_SESSION["id"];
  $rqt = "INSERT INTO `Album` (`URL`,`id_utilisateur`) VALUES ('$ch','$id')";
  $bdd->query($rqt);
}$ch=0;
...
<section class="intro-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 col-lg-8">
          <div class="intro">
            <div class="profile-img"><img src="<?php echo $_SESSION["Photo"]; ?>" height="200" alt=""></div>
            <h2><b><?php echo $_SESSION["prenom"]; echo " "; echo $_SESSION["nom"]; ?></b></h2>
            <h4 class="font-yellow"><?php echo $_SESSION["statut"];?></h4>
            <ul class="information margin-tb-30">
              <li><b>Né le : </b><?php echo $_SESSION["naissance"]; ?></li>
              <li><b>Adresse mail :</b> <?php echo $_SESSION["mail"]; ?></li>
            ...
            <div id="idFond" class="fond">&nbsp;</div>
              <div id="monPrompt" class="conteneurPrompt">
                <div class="titrePrompt">Modification des infomations</div>
                <div class="contenuPrompt">
                  <div id="upload" class="tab-pane fade in active">
                    ...
                    Statut&nbsp;:
                    <input type="text" name="Statut" value="Votre texte" id="idText" size="20" maxlength="100" /><br />
                    Date de Naissance&nbsp;:
                    ...
                    Photo de profil&nbsp;:
                    <input id="fileToUpload" name="fileToUpload" type="file" multiple class="file-loading" / ><br />
                      <div class="boutonsPrompt"><br />
  ...
  <section class="portfolio-section section">
    ...
    <div class="portfolioContainer">
      ...
      <?php
      while($donnees=$bidule->fetch())
      {
        $lien=$donnees['URL'];
      ?>
      <div class="p-item web-design">
        <a href="<?php echo $lien ?>" data-fluidbox>
          <img src="<?php echo $lien?>" class="truc" alt=""></a>
      </div><!-- p-item -->
      <?php
    }
    ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-8">
          ...
          <button type="button" class="btn btn-warning btn-lg" href="#" onclick="ouvreBoite2()">Modifier les infos</button>

          <div id="idFond2" class="fond2">&nbsp;</div>
          <div id="monPrompt2" class="conteneurPrompt2">
            <div class="titrePrompt2"> Modification de ma description </div>
